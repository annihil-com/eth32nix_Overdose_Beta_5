...
const static settingdef_t settingsDefs[] =
{
	...
	//	Min / Max
	//		Value				TextValue
	{ "champlayer",			"11",			SETTING_INT,		(void*)&eth32.settings.chamsPlayer,
	...
	{ "chamweapon",			"21",			SETTING_INT,		(void*)&eth32.settings.chamsWeapon,
	...
	{ "outcham",			"6",		SETTING_INT,		(void*)&eth32.settings.outChams,
		"set the style of chams to be applied to outline",
	...
	{ "ourweapcham",		"true",		SETTING_BOOL,		(void*)&eth32.settings.chamsOurWeapon,
		"apply weapon chams to our own weapon",
	},
	{ "weapoutcham",        	"6",		SETTING_INT,        	(void*)&eth32.settings.weapoutChams,
		"Toggle weapon Outchams on and off",
               CHAMSOUT_OFF, MAX_CHAMSOUT-1,
               {
			//{ (int)CHAMSOUT_OFF,		"off" },
			{ (int)CHAMSOUT_ORIG,		"original" },
	...
	{ "outweapcham",	"true",			SETTING_BOOL,		(void*)&eth32.settings.outchamweapon,
 		"apply weapon outchams to all weapons",
	},
	...
	{ "xhairsize",			"6",			SETTING_FLOAT,		(void*)&eth32.settings.crossSize,
		"sets custom crosshair size",
		0, 100,
	},
	{ "xhairthick",			"2",			SETTING_FLOAT,		(void*)&eth32.settings.crossThick,
	...
	{ "warningmsg",			"true",			SETTING_BOOL,		(void*)&eth32.settings.showReload,
	...
	{ "human1_speed",		"0.5",		SETTING_FLOAT,		(void*)&eth32.settings.human1_speed,
		 "Simple Logins - Speed",
 	},
	...
	{ "aimsort",			"6",			SETTING_INT,		(void*)&eth32.settings.aimSort,
	...
	{ "selectTrace",		"4",			SETTING_INT,		(void*)&eth32.settings.selectTraceType,
		"set the style of trace used to determine if a target is visible",
		0, SEL_MAX-1,
		{
			{ (int)SEL_CENTER,			"center" },
			{ (int)SEL_CONTOUR,			"contour" },
			{ (int)SEL_RANDOM_VOLUME,		"randvolume" },
			{ (int)SEL_RANDOM_SURFACE,		"randsurface" },
            		{ (int)SEL_CAPSULE_VOLUME,	        "capvolume" },
            		{ (int)SEL_CAPSULE_SURFACE,		"capsurface" },
		},
	},
	...
	{ "grenadeZ",			"0",			SETTING_FLOAT,		(void*)&eth32.settings.grenadeZ,
		"z correction for grenade aimpoint",
	},
	{ "riflenadeZ",			"-12",			SETTING_FLOAT,		(void*)&eth32.settings.riflenadeZ,
	...
	{ "grensenslock", 		"true",			SETTING_BOOL,		(void*)&eth32.settings.grenadeSenslock,
	...
	{ "radiusdamage",		"200",			SETTING_FLOAT,		(void*)&eth32.settings.radiusDamage,
	...
	{ "predictiontype",			"3",		SETTING_INT,		(void*)&eth32.settings.predictionType,
		"sets the custom crosshair type",
		0, PRED_MAX-1,
		{
			{ (int)PRED_BASIC,	"Basic" },
			{ (int)PRED_SNAP,	"Snapshot" },
			{ (int)PRED_MULTI, 	"Multi" },
			{ (int)PRED_MIX, 	"Speed/Distance" },
		},
	},
	/*{ "predtarget",			"0",			SETTING_FLOAT,		(void*)&eth32.settings.predTarget,
	...
	{ "pred",			"-0.022",		SETTING_FLOAT,		(void*)&eth32.settings.pred,
	...
	//Alexplay: merged all auto correction commands into a single one, tidier and will avoid confusion.
	{ "autocorrections",		"true",			SETTING_BOOL,		(void*)&eth32.settings.autocorrections,
		"enables all kind of auto corrections (vecs, hitbox, etc)",
	},
	...
	{ "standfarz",			"2.500",		SETTING_FLOAT,		(void*)&eth32.settings.vecstandfarZ,
	...
	{ "crouchfarz",			"2.500",		SETTING_FLOAT,		(void*)&eth32.settings.veccrouchfarZ,
	...
	{ "headhitboxfar",	   	"0",	    		SETTING_FLOAT,		(void*)&eth32.settings.farBoxSize,
		"head hitbox size (far distance)",
		0, 20,
	},
	{ "headhitboxclose",	   	"10.000",	    	SETTING_FLOAT,		(void*)&eth32.settings.closeBoxSize,
	...
	{ "predself",		"-0.024",			SETTING_FLOAT,		(void*)&eth32.settings.predSelf,
		"set amount to prediction to applied to our own movement (only for manual)",
		-1, 1,
	},
	{ "predself_type",		"2",			SETTING_INT,		(void*)&eth32.settings.predSelfType,
	...
	/*{ "dynamichitbox",		"0",			SETTING_FLOAT,		(void*)&eth32.settings.dynamicHitboxScale,
	...
	{ "bulletrailtime",		"30",			SETTING_INT,		(void*)&eth32.settings.bulletRailTime,
	...
	{ "autopreaimshoot",		"false",		SETTING_BOOL,		(void*)&eth32.settings.autoPreAimShoot,
		"automatic preaim and preshoot time based on your ping",
	},
	{ "preaim",			"false",		SETTING_BOOL,		(void*)&eth32.settings.preAim,
		"preaim targets",
	},
	{ "preaimtime",			"100",		SETTING_FLOAT,		(void*)&eth32.settings.preAimTime,
	...
	{ "preshoottime",		"100",			SETTING_FLOAT,		(void*)&eth32.settings.preShootTime,
		"preshoot time - higher means earlier shot (and higher chance of miss)",
		0, 5000,
	},
	{ "spread",			"200",			SETTING_FLOAT,		(void*)&eth32.settings.spread,
		"weapon spread test",
		10, 500,
	},
	// custom hitbox
	...
	{ "bannerfmt", "^nKills: ^1[k] ^0| ^nDeaths: ^1[d] ^0| ^nAccuracy: ^1[\\]^n% ^0| ^nHeadshots: ^1[/] &&^nHealth: ^1[h] ^0| ^nAmmo: ^1[a] ^0| ^nCurrent Spree: ^1[S] ^0| ^nPBSS: ^1[s]", SETTING_STRING, (void*)eth32.settings.BannerFmt,
		"banner format",
	},
