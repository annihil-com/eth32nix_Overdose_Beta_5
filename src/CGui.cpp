...
void CGui::Init(void)
{
	...
	if (init) {
		...
		ChatMessage("^7ETH^332 ^7(^3c^7)2009 - ^7nixcoders.org & rabbnix.com");*/
		return;
	}
	...
	ChatMessage("^7ETH^332nix ^7(^3c^7)2009 - ^7nixcoders.org & rabbnix.com");*/
	...
	winPicker->AddWindow("Grenadebot", CAT_MISC);
	...
	//winPicker->AddWindow("Banner Setup", CAT_VISUAL);
	...
	colorPicker->AddColor("Weapons Outline", eth32.settings.TeamWeaponOutline);
