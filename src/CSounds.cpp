...
void CSounds::RegisterSounds( void )
{
	...
	eth32.cg.media.sounds.hitsound2 = Syscall.S_RegisterSound("sounds/hitsound/headshot1.wav", qtrue);
	eth32.cg.media.sounds.hitsound3 = Syscall.S_RegisterSound("sounds/hitsound/hit3.wav", qtrue);
	eth32.cg.media.sounds.hitsoundtm = Syscall.S_RegisterSound("sounds/hitsound/body.wav", qtrue);
