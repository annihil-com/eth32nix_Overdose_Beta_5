...
: CWindow(wlabel, wx, wy, ww, wh)
{
	...
	buttons[CAT_AIMBOT] = new CWindowButton("Aimbot", 5, 5, 150, 16, CAT_AIMBOT, this);
	buttons[CAT_VECS] = new CWindowButton("Vecs", 5, 5, 150, 16, CAT_VECS, this);
	buttons[CAT_VISUAL] = new CWindowButton("Visuals", 5, 5, 150, 16, CAT_VISUAL, this);
	buttons[CAT_MISC] = new CWindowButton("Misc", 5, 5, 150, 16, CAT_MISC, this);
